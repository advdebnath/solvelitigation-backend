...
def process_judgment(ingestion_id):
    ...
    canonical_header_text[:2500]
        ...
        # =====================================================
        # 🔒 JUDGMENT DOCUMENT OVERRIDE
        # =====================================================

        is_real_judgment = bool(
            re.search(
                r'''
                REPORTABLE|
                NON[- ]REPORTABLE|
        ...
        if is_real_judgment:
            ...
            print(
                "🔒 DOCUMENT CLASSIFIER OVERRIDE: JUDGMENT"
            )
        ...
        try:
            ...
            if raw_date:
                ...
                if (
                    ...
                    print("🚫 DATE REJECTED BY YEAR FIREWALL")
                    print(raw_date)
        ...
        print("🔥 DATE PIPELINE OUTPUT")
        print({
            "raw_date": raw_date,
            "parsed": str(parsed_judgment_date)
        })
        ...
        print("🔥 FINAL SAVE AUDIT")
        print({
            "ingestion_id": str(ingestion_id),
            "case": judgment_doc.get("caseNumber"),
            "judgmentDate": judgment_doc.get("judgmentDate")
        })
