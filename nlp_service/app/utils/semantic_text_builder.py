...
def build_semantic_reasoning_text(raw_legal_text):
    ...
    immutable_copy = str(raw_legal_text)

    # -----------------------------------------------------
    # 🔒 NORMALIZED SEMANTIC SOURCE
    # -----------------------------------------------------

    semantic_text = normalize_legal_text(immutable_copy)
    ...
    assert raw_legal_text == immutable_copy
