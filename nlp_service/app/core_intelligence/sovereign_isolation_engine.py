...
def validate_federation_access(

    source_federation,
    target_federation
):

    for blocked in SOVEREIGN_ISOLATION[
        "blocked_routes"
    ]:
        ...
        if (
            ...
            and
            blocked["target"] == target_federation
        ):
