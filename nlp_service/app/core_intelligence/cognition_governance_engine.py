...
def evaluate_cognition_governance(
    ...
    try:
        ...
        stability = optimization_profile.get(
            "system_stability",
            1.0
        )
        ...
        constitutional_growth = evolution_data.get(
        ...
        if constitutional_growth > 0.90:
            ...
            governance[
                "constitutional_overreach_risk"
            ] = True

            governance[
                "governance_actions"
            ].append(
                "constitutional_rebalancing"
            )
        ...
        weak_agents = optimization_profile.get(
            "weak_agents",
            []
        )
