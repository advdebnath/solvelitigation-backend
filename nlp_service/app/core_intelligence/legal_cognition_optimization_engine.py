...
def update_agent_performance(
    ...
    try:
        ...
        print(
            "❌ AGENT PERFORMANCE UPDATE ERROR:"
        )
...
def update_semantic_resolution(
...
def build_optimization_profile():
    ...
    try:
        ...
        for agent, score in COGNITION_OPTIMIZATION[
            "agent_scores"
        ].items():
        ...
        resolutions = COGNITION_OPTIMIZATION[
            "semantic_resolution_scores"
        ]
        ...
        for mode, values in COGNITION_OPTIMIZATION[
            "routing_efficiency"
        ].items():

            if values:

                profile["routing_modes"][mode] = round(
