...
def build_headnote_jurisprudence(
    ...
    for point in list(
        dict.fromkeys(sanitized_points)
    )[:10]:
...
if __name__ == "__main__":
    ...
    print(
        build_headnote_jurisprudence(sample)
    )
