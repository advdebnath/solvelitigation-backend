...
from app.core_intelligence.evidentiary_agent import run_evidentiary_analysis
...
from app.core_intelligence.self_validation_agent import run_self_validation
...
AGENT_REGISTRY = {
    "validation": run_self_validation,
    "evidentiary": run_evidentiary_analysis,
    "procedural": run_procedural_timeline_analysis,
    "semantic_graph": run_semantic_graph_analysis,
    "rag": run_rag_reasoning_analysis,
    "agentic": run_agentic_reasoning_analysis,
    "strategy": run_strategy_orchestration,
}
