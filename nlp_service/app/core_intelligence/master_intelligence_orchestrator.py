...
from app.core_intelligence.entity_resolution_engine import (
    resolve_entities
)
...
from app.core_intelligence.precedent_graph_engine import (
    build_precedent_graph
)
...
def run_full_jurisprudential_intelligence(
    ...
    try:
        ...
        intelligence[
            ...
            canonical_entity=current_case.get(
                "petitioner",
                ""
            ),
    ...
    try:
        ...
        precedent_graph = build_precedent_graph(
            ...
            candidate_cases=historical_cases
        )
    ...
    try:
        ...
        doctrine_data = build_doctrine_evolution(
            ...
            doctrine_name=current_case.get(
                "issue",
                "UNKNOWN"
            ),
