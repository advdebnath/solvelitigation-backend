...
def run_semantic_graph_analysis(
    ...
    try:
        ...
        doctrine_clusters = {
            ...
            "PROPORTIONALITY":
                "PROPORTIONALITY_CLUSTER",

            "ARBITRARINESS":
                "ADMINISTRATIVE_CLUSTER",

            "BAIL":
                "CRIMINAL_LIBERTY_CLUSTER",
        ...
        for trigger, cluster in doctrine_clusters.items():
            ...
            if trigger in upper_text:
                ...
                doctrine_evolution_topology.append(
                    trigger
                )
