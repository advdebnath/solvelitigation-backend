...
def build_case_summary(case):
    ...
    issue = case.get("dominant_issue")

    if issue:

        parts.append(f"Issue: {issue}")

    holding = case.get("final_holding")
    ...
    if doctrine:
        ...
        parts.append(f"Doctrine: {doctrine}")
...
def generate_multi_case_reasoning(cases):
    ...
    try:
        ...
        result = {
            "multi_case_reasoning": reasoning,
            "comparative_analysis": comparative,
            "confidence": 95,
        }

        print("✅ Multi-Case Reasoning Generated:")
        ...
        print("❌ Multi-Case Reasoning Error:", str(e))

        return {"multi_case_reasoning": "", "comparative_analysis": [], "confidence": 0}
...
if __name__ == "__main__":
    ...
    sample_cases = [
        {
            "dominant_issue": "Natural Justice",
            "final_holding": "Appeal Allowed",
            "doctrine": "procedural fairness",
        },
        {
            "dominant_issue": "Constitutional Due Process",
            "final_holding": "High Court Set Aside",
            "doctrine": "due process",
        },
    ]

    print(generate_multi_case_reasoning(sample_cases))
