...
def detect_behaviour_traits(text):
    ...
    for trait, patterns in TRAIT_PATTERNS.items():
        ...
        if score > 0:
            ...
            findings[trait] = {
                "score": min(score, 100),
                "signals": list(set(matches_found)),
            }
...
def analyze_judge_behaviour(
    full_text="", judges=None, operative_data=None, dominant_issue=None
):
    ...
    try:
        ...
        traits = detect_behaviour_traits(full_text)
        ...
        behaviour["dominant_behaviour"] = dominant_trait

        behaviour["confidence"] = min(95, 50 + highest_score)
        ...
        if isinstance(dominant_issue, dict):
            ...
            behaviour["dominant_issue"] = dominant_issue.get(
        ...
        if isinstance(operative_data, dict):
            ...
            behaviour["operative_holding"] = operative_data.get(
        ...
        print("❌ Judge Behaviour Error:", str(e))
