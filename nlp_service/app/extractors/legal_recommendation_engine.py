...
def build_strategy(
    ...
    if issue_data:
        ...
        if dominant:
            ...
            recommendations.append(f"Focus litigation strategy on {dominant.lower()}.")
    ...
    if ratio_data:
        ...
        if ratios:
            ...
            principles = ratios[0].get("legal_principles", [])
    ...
    if outcome_data:
        ...
        outcome = outcome_data.get("predicted_outcome")

        if outcome:

            recommendations.append(f"Predicted litigation trend: {outcome}.")
...
def generate_legal_recommendations(
    ...
    try:
        ...
        print("✅ Legal Recommendations Generated:")
        ...
        return {"primary_strategy": "", "recommendations": [], "confidence": 0}
