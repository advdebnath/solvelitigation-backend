...
def build_ratio_issue_fusion(
    ...
    fusion["fusion_summary"] = ". ".join(
        summary_parts
    )

    fusion["confidence"] = int(
        min(
            95,
            fusion["confidence"]
        )
