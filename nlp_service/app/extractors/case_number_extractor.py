...
def extract_case_number(text, fallback="Unknown Case"):
    ...
    try:
        ...
        # =====================================================
        # 🔒 EARLY HEADER BODY CUT-OFF LOCK
        # =====================================================
        ...
        for pattern in generic_patterns:
            ...
            try:
                ...
                print("❌ FALLBACK CASE PATTERN ERROR:")
                print(pattern)
        ...
        if candidate_results:
            ...
            print("❌ NO VALID CASE NUMBER CANDIDATES FOUND")

            print("🧪 HEADER TEXT SAMPLE:")
        ...
        if petitioner_match and respondent_match and not candidate_results:
            ...
            if any(token in title_case.upper() for token in invalid_caption_tokens):
                ...
                return {
                    ...
                    "canonical_case_number": "Unknown Case",
