...
OUTCOME_MAP = {
    "FIR Quashing": {
        "predicted_outcome": "Petition likely to be allowed.",
        "risk": "Low",
    },
    "Liberty Oriented Bail Jurisprudence": {
        "predicted_outcome": "Bail likely to be granted.",
        "risk": "Moderate",
    },
    "Premature Release Of Life Convicts": {
        "predicted_outcome": "Likely remission consideration or partial relief.",
        "risk": "Moderate",
    },
    "Minimal Arbitration Interference": {
        "predicted_outcome": "Challenge to arbitral award likely dismissed.",
        "risk": "Moderate",
    },
    "Natural Justice Expansion": {
        "predicted_outcome": "Impugned order likely to be quashed.",
        "risk": "Low",
    },
    "Cheque Dishonour": {
        "predicted_outcome": "Conviction likely to be sustained.",
        "risk": "Moderate",
    },
}
...
def simulate_judgment_outcome(
    ...
    try:
        ...
        result = {
            ...
            "predicted_outcome": "Outcome uncertain.",
            "risk": "Moderate",
            "confidence": 0,
        ...
        outcome_data = OUTCOME_MAP.get(issue, {})

        result["predicted_outcome"] = outcome_data.get(
            "predicted_outcome", "Outcome uncertain."
        )

        result["risk"] = outcome_data.get("risk", "Moderate")
        ...
        if isinstance(ai_argument_data, dict):
            ...
            result["supporting_arguments"] = ai_argument_data.get("arguments", [])
        ...
        if isinstance(ai_argument_data, dict):
            ...
            confidence += len(ai_argument_data.get("arguments", [])) * 3

        result["confidence"] = min(95, confidence)
        ...
        print("❌ Outcome Simulation Error:", str(e))
